...
class Repo {
  ...
  static Future<List<PointLatLng>> getRouteBetweenTwoPoints({
    ...
    String apiKey = "0WdrhbWShU8JjzcRBBvCTJ4c8oclHDUDFdv38GslOupxJxpskC5MGSKDvFWoMWyn";
    String url =
...
fetchData() async {
    ...
    try {
      final response = await dio.get('http://ec2-43-204-130-153.ap-south-1.compute.amazonaws.com:5000/data/latest');
      if (response.statusCode == 200) {
